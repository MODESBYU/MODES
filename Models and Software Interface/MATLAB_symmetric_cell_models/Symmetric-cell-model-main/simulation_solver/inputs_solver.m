...
function [EL,GEO,SIM,N,FLAG] = inputs_solver(SIM,x)
%% FLAGS
...
EL.D_o_Li_ion = Do; % [m^2 s^-1], Li^+ liquid diffusion coefficient
EL.tf_num     = tp;   % [-], Transference Number
